...
#include "app_usb_hid.h"        //added by Trion on 2026/09/02
...
// Trigger this inside your existing esp-sr speech recognition event handler
...
void detect_Task(void *arg)
{
    ...
    int nMillisecondsToDetect=7000;  //wait for 7 seconds to make sure the AFE is ready to feed data to multinet.
    esp_mn_iface_t *multinet = esp_mn_handle_from_name(mn_name);
    model_iface_data_t *model_data = multinet->create(mn_name, nMillisecondsToDetect);
